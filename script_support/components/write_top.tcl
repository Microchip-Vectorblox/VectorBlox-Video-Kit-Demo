...
sd_create_bus_port -sd_name ${sd_name} -port_name {data_o_0} -port_direction {OUT} -port_range {[255:0]}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_o_0" "write_mux_0:data_o" }
