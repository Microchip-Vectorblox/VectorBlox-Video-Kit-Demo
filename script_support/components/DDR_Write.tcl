...
sd_create_bus_port -sd_name ${sd_name} -port_name {data_i} -port_direction {IN} -port_range {[127:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {process_next_next_frame_addr_o} -port_direction {OUT} -port_range {[31:0]}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:A" "DDR_write_controller_0:reset_i" "data_packer_0:reset_i" "reset_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_0:save_frame_i" "save_frame_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_0:start_i" "data_packer_0:start_ddr_w_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_0:sys_clk_i" "ddr_clock_i" "video_fifo_0:rclock_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_packer_0:sys_clk_i" "parallel_clk_i" "video_fifo_0:wclock_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_0:process_frame_addr_o" "process_frame_addr_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_0:process_next_frame_addr_o" "process_next_frame_addr_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_0:process_next_next_frame_addr_o" "process_next_next_frame_addr_o" }
