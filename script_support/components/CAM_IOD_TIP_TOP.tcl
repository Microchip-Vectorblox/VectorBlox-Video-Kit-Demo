...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C0_0:BIT_ALGN_EYE_IN} -value {010}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C1_0:BIT_ALGN_EYE_IN} -value {010}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:BIT_ALGN_EYE_IN} -value {010}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:DEM_BIT_ALGN_TAPDLY}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:RX_BIT_ALIGN_LEFT_WIN}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:RX_BIT_ALIGN_RGHT_WIN}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:BIT_ALGN_EYE_IN} -value {010}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:DEM_BIT_ALGN_TAPDLY}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:RX_BIT_ALIGN_LEFT_WIN}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:RX_BIT_ALIGN_RGHT_WIN}



# Add PF_IOD_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {PF_IOD_GENERIC_RX_C1} -instance_name {PF_IOD_0}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {PF_IOD_0:EYE_MONITOR_WIDTH} -value {010}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C1_0:FABRIC_RESET_N" "CORERXIODBITALIGN_C0_0:RESETN" "CORERXIODBITALIGN_C1_0:RESETN" "CORERXIODBITALIGN_C2_0:RESETN" "CORERXIODBITALIGN_C3_0:RESETN" }
