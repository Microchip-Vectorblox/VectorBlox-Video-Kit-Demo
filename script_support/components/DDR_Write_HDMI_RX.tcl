...
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {DDR_write_controller} -hdl_file {hdl/DDR_write_controller.vhd} -instance_name {DDR_write_controller_HDMI_RX_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:A" "DDR_write_controller_HDMI_RX_0:reset_i" "data_packer_0:reset_i" "reset_i" "synchronizer_circuit_0:reset_n" "synchronizer_circuit_1:reset_n" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:frame_valid_i" "data_packer_0:frame_valid_i" "frame_valid_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:start_i" "data_packer_0:start_ddr_w_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:horiz_resolution_i" "data_packer_0:h_count_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:process_next_next_frame_addr_o" "process_next_next_frame_addr_o" }
