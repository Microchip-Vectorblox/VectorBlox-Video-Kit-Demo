...
riscv_hal/%.o: ../riscv_hal/%.S
	...
	riscv64-unknown-elf-gcc -march=rv32im -mabi=ilp32 -msmall-data-limit=8 -mno-save-restore -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g -x assembler-with-cpp -I"C:\Microchip\Videokit\drivers\CoreGPIO" -I"C:\Microchip\Videokit" -I"C:\Microchip\Videokit\drivers\CoreI2C" -I"C:\Microchip\Videokit\drivers\CoreSPI" -I"C:\Microchip\Videokit\drivers\CoreUARTapb" -I"C:\Microchip\Videokit\riscv_hal" -I"C:\Microchip\Videokit\hal" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
